<template>
  <div>
      ...
      <el-table :data="orderlist" style="width: 100%" border stripe>
        ...
        <el-table-column prop="pay_status" label="是否付款">
          <template v-slot="scope">
            <el-tag type="success" v-if="scope.row.pay_status=='1'">以付款</el-tag>
    ...
    <!-- 修改地址的对话框 -->
    <el-dialog title="修改地址" :visible.sync="editAddressDialogVisible" width="50%" @close="editAddressClose">

      <!-- 表单验证 -->
      <el-form :model="editAddressForm" :rules="editAddressRules" ref="editAddressRef" label-width="100px">
        <el-form-item label="省市区/县" prop="address1">
          <el-cascader v-model="editAddressForm.address1" :options="cityData" :props="cascaderProps" @change="handleChange"></el-cascader>
    ...
    <!--展示  物流进度 对话框  -->
    <el-dialog title="" :visible.sync="showProgressDialogVisible" width="50">
...
export default {
 ...
 methods: {
  ...
  // 级联选择框 选项变化触发
  handleChange() {
    console.log(this.editAddressForm.address1);
  },
  // 编辑地址的 对话框 关闭事件 清空表单 （）
  editAddressClose() {
